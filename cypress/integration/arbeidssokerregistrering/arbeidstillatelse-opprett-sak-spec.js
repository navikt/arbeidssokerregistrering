describe("/fullfor - Mangler arbeidstillatelse opprett sak", () => {
    ...
    it("TA KONTAKT - Knapp vises", () => {
        cy.get('[class="knapp avbryt-modal__knapp blokk-s knapp--hoved"]').should(
            "exist"
        );
    });
    it("TA KONTAKT - Oppretter sak - Henvendelse mottatt", () => {
        ...
        cy.get('[class="typo-systemtittel blokk-m"]').should(
            "contain",
        ...
        cy.get('[class="typo-normal blokk-m"]>a')
            ...
            .should(
                "have.attr",
                "href",
                "https://brukerprofil.difi.no/minprofil?locale=nb"
            );
        cy.get('[class="typo-normal blokk-m"]>a')
            .eq(1)
            .should(
                "have.attr",
                "href",
                "https://brukerprofil.difi.no/minprofil?locale=en"
            );
    });
