  ...
  return (
    <Panel border>
      ...
      <Normaltekst className="blokk-s">
        Du står registrert som utvandret i våre systemer.
        <br />
        Dette gjør at du ikke kan registrere deg som arbeidssøker på nett.
      </Normaltekst>
      <Normaltekst className="blokk-m">Kontakt oss, så hjelper vi deg videre.</Normaltekst>
      ...
      <Normaltekst className="blokk-s">
        You're listed as emigrated in our systems.
        <br />
        This means that you cannot register as a jobseeker online.
      </Normaltekst>
      <Normaltekst className="blokk-m">Please contact us for help with this.</Normaltekst>
    </Panel>
  );
};
