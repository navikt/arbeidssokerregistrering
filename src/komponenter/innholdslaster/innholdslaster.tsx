...
const noenHarFeil = (avhengigheter: Array<{}>) => avhengigheter?.some(harStatus(STATUS.ERROR))
const alleLastet = (avhengigheter: Array<{}>) => avhengigheter?.every(harStatus(STATUS.OK))
const alleLastetEllerReloading = (avhengigheter: Array<{}>) => (
...
class Innholdslaster extends React.Component<InnholdslasterProps, InnholdslasterState> {
  ...
  render () {
    ...
    const loader = loaderKomponent ?? <Laster className='innholdslaster-laster' storrelse={storrelse} />
