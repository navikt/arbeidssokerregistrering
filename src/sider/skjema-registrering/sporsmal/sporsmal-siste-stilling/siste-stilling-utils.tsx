...
export function hentOversattStillingFraAAReg(data: OversettelseAvStillingData): Stilling {
...
export function getDefaultSvar(sisteStilling: Stilling): SisteStillingSvar {
  return sisteStilling === ingenYrkesbakgrunn ? SisteStillingSvar.HAR_IKKE_HATT_JOBB : SisteStillingSvar.HAR_HATT_JOBB;
}
