  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <p>
          Vi klarte ikke å ta imot henvendelsen din. Vennligst forsøk igjen senere. Opplever du dette flere ganger kan
          du ringe oss på <strong>55 55 33 33</strong>.
        </p>
        <p>
          We’re having trouble with your request right now. Please try again later. If you are still having problems,
          you can call us on <strong>55 55 33 33</strong>.
        </p>
      </Veilederpanel>
    );
  }
