      ...
      <Panel border className="nav-veilederpanel">
        ...
        <Fieldset legend="" id="veiledervalg">
            ...
            <Normaltekst className="hidden" id="aap-skal-soke-result">
                <a href={DIALOG_URL} id="aap-skal-soke-dialog" onClick={ handleDialogClick }>Ta kontakt med veilederen din gjennom dialogverktøyet</a>
            </Normaltekst>
            ...
            <Normaltekst className="hidden" id="jobbendring-result">
                <a href={DIALOG_URL} id="jobbendring-dialog" onClick={ handleDialogClick }>Ta kontakt med veilederen din gjennom dialogverktøyet</a>
            </Normaltekst>
            ...
            <Normaltekst className="hidden" id="veileder-result">
                <a href={DIALOG_URL} id="veileder-dialog" onClick={ handleDialogClick }>Ta kontakt med veilederen din gjennom dialogverktøyet</a>
            </Normaltekst>
