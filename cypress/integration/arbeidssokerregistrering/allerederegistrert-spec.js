...
describe('/allerederegistrert', () => {
    beforeEach(() => {
        utils.configureCypress('allerederegistrert');
    })
    it('/allerederegistrert - riktig side vises', () => {
        cy.visit('/');
        cy.get('[class="typo-normal alertstripe__tekst"]')
            .should('contain', 'Vi må hjelpe deg videre i andre kanaler');
    });
