package no.nav.sbl.arbeidssokerregistrering.util;
...
public class DecoratorUtils {
    ...
    private static final String APPLICATION_NAME = "arbeidssokerregistrering";
    ...
    private static final String appresUrl = getRequiredProperty("APPRES_CMS_URL");
