...
import FeilmeldingBrukersStatusUgyldig from '../../fullfor/feilhandtering/feilmelding-brukers-status-ugyldig';
...
// todo: Lag en felles komponent for reaktivering-feilhandtering og fullfor-feilhandtering
