...
export default class NAVSPA {
  private static readonly scope: NAVSPAScope = ((window as any).NAVSPA = (window as any).NAVSPA || {})
  ...
  public static importer<PROPS>(name: string): React.ComponentType<PROPS> {
    class NAVSPAImporter extends React.Component<PROPS, State> {
      ...
      private readonly saveRef = (el: HTMLDivElement) => {
        this.el = el
      }

      private readonly initHandler = (retryInterval: RetryInterval) => {
        try {
          if (this.el) {
